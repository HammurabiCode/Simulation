...
//-------------------------------------------------------------------------
static inline void substract(vect *a, const vect *a1, const vect *a2)
{
  a->x = a1->x - a2->x;
  a->y = a1->y - a2->y;
  a->z = a1->z - a2->z;
...
//-------------------------------------------------------------------------
static inline void add(vect *v, const vect *v1, const vect *v2)
{
  v->x = v1->x + v2->x;
  v->y = v1->y + v2->y;
  v->z = v1->z + v2->z;
}
static inline void add2(vect *v, const vect *v0)
{
  add(v, v, v0);
}
//-------------------------------------------------------------------------
